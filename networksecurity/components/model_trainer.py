...
class ModelTrainer:
    def __init__(self,model_trainer_config:ModelTrainingConfig,data_transformation_artifact:DataIngestionArtifact):
        try:
    ...
    def track_mlflow(self, best_params, classification_metric):
        try:
